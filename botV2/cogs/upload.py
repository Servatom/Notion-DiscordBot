...
class Upload(commands.Cog):
    ...
    async def upload(self, ctx, *args):
        ...
        # ask for title
        embed = discord.Embed(title="Enter the title of the file", description="", color=discord.Color.green())
        await ctx.send(embed=embed)
        try:
            ...
            embed = discord.Embed(title="Timed out", description="", color=discord.Color.red())
            await ctx.send(embed=embed)
            return
